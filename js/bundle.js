...
Learn.loadGenomes = function (genomes, deleteOthers){
    ...
    console.log('Loaded '+loaded+' genomes!');
}
...
},{"async":4,"lodash":5,"synaptic":10}],3:[function(require,module,exports){
/*
...
$(document).ready(function() {
   ...
   if(window.location.search == "?easy")
      pipeheight = 200;
   setInterval(Learner.readGameState, 100);
...
function gameloop() {
   ...
   if(pipes[0] == null)
   {
       Learner.readSensors([position, velocity, 900, 0, 0]);
       return;
   }
   ...
   // console.log(pipetop / flyArea);
   // console.log(pipeleft / 800);
   //  console.log(pipetop);
    // position / flyArea
    // console.log((velocity + 4) / 20);
    // var positionInput = position / flyArea;
    // var velocityInput = (velocity + 4)/20;
    // var pipeLocation = (pipeleft / 800);
    // var pipetopInput = (pipetop / flyArea);

    Learner.readSensors([position, velocity, pipeleft, pipetop, pipebottom]);
...
function playerDead()
{
    Learner.point = Learner.point + score*100;
   Learner.gameEnd = true;
...
},{"./Learner":2}],4:[function(require,module,exports){
...
},{"./layer":7,"./network":8,"./trainer":11}],7:[function(require,module,exports){
// export
...
},{"./layer":7,"./neuron":9,"./trainer":11}],9:[function(require,module,exports){
// export
...
},{"./architect":6,"./layer":7,"./network":8,"./neuron":9,"./trainer":11}],11:[function(require,module,exports){
// export
